...
BUILD=$(echo $(curl https://download-installer.cdn.mozilla.net/pub/firefox/nightly/latest-mozilla-release-l10n/linux-$ARCHITECTURE/xpi/) | sed -r "s/.*firefox-([0-9\.a]+)\.$LOCALE\.langpack\.xpi.*/\1/")
...
URL="https://download-installer.cdn.mozilla.net/pub/firefox/nightly/latest-mozilla-release-l10n/firefox-{$BUILD}.{$LOCALE}.linux-{$ARCHITECTURE}.tar.bz2"
